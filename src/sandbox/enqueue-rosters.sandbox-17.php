...
$out[] = $row;
        ...
        // SAFETY RAIL: never allow a logic regression to wipe assignments.
// If input had assignments but output is empty, return original unchanged.
if ( is_array( $assigned_arr ) && count( $assigned_arr ) > 0 && count( $out ) === 0 ) {
