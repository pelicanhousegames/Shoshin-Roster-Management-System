...
function ensureRmsLockedModal() {
  ...
  rmsLockedModal.innerHTML = ''
    + '<div class="shoshin-modal-inner">'
    +   '<button type="button" class="shoshin-modal-x" aria-label="Close">×</button>'
    +   '<div class="shoshin-modal-title">Over Free-tier limit</div>'
    +   '<div class="shoshin-modal-body">'
    +     '<div class="shoshin-modal-msg" style="margin:6px 0 0;"></div>'
    +   '</div>'
    +   '<div class="shoshin-modal-actions">'
    +     '<button type="button" class="shoshin-btn shoshin-modal-btn-confirm">OK</button>'
    +   '</div>'
    + '</div>';
  ...
  var okBtn = rmsLockedModal.querySelector('.shoshin-modal-btn-confirm');
...
function openRmsLockedModal(msg) {
  ...
  if (msgEl) msgEl.textContent = String(msg || 'Over Free-tier limit...');
