...
@media screen{
  ...
  /* SCREEN ONLY: multi-frag stack preview */
  .print-frag{
    width: 11in;
    min-height: 8.5in;
    height: auto;
    margin: 0 auto 24px auto;
    padding: 0.45in; /* preview-only */
    box-sizing: border-box;
    background: #fff;
  ...
  /* IMPORTANT: paginator wrappers must not clamp in screen preview */
  .print-frag-inner{
...
@media print{
  ...
  .print-body{ margin-top: 0 !important; }
}
...
/* Seatbelt: never allow legacy overlap to reappear */
.print-row-block-cm.is-overlap-ok{ margin-top: 0 !important; }
...
/* Brace glyph */
.print-cm-brace{ text-align:center; }
...
/* =========================================================
   ROW2
========================================================= */
.print-row-block-row2{ margin-top: 6px; }
...
@media print{
  ...
  .print-unit-row{ padding: 6px 8px; }

  /* tighten vertical rhythm between Row1 and Row2 blocks */
  .print-row-block-cm{ margin-top: 3px; }
  .print-row-block-row2{ margin-top: 3px; }
