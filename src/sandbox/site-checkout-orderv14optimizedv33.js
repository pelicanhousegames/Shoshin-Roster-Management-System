  ...
  function hydrateClassicCheckoutExpressCard() {
    ...
    lateMountSelectors.forEach(function (selector) {
      document.querySelectorAll(selector).forEach(function (node) {
        if (!node || expressCard.contains(node)) return;
        expressCard.appendChild(node);
      });
    });
...
function initClassicCheckoutShippingUpdateControl() {
  ...
  function initClassicCheckoutShell() {
    ...
    window.setTimeout(reconcileClassicCheckoutShell, 80);
    window.setTimeout(reconcileClassicCheckoutShell, 260);
    window.setTimeout(reconcileClassicCheckoutShell, 700);
    window.setTimeout(reconcileClassicCheckoutShell, 1400);
  }
  ...
  jQuery(document.body).on('updated_checkout', function () {
    ...
    window.setTimeout(reconcileClassicCheckoutShell, 900);
  });
...
/* =========================================
   DEBOUNCE WC CHECKOUT UPDATES (Shippo fix)
========================================= */
...
(function($){
  ...
  // Kill aggressive default triggers and replace with debounce
  ...
  function triggerDebouncedUpdate() {
    ...
    updateTimer = setTimeout(function () {
      console.log('Debounced update_checkout fired');
      $(document.body).trigger('update_checkout');
    }, 600); // ← critical (tune if needed)
  }

  // Watch all relevant fields
  $('form.checkout').on('input change', 
