...
/**
 * Shoshin wrapper shortcode for Nextend Social Login
 * Usage: [shoshin_social_login]
 */
add_shortcode('shoshin_social_login', function ($atts = []) {
    if (!class_exists('NextendSocialLogin')) {
        return '';
    }

    // Render the Nextend button container directly.
    return NextendSocialLogin::renderButtonsWithContainer();
});