...
function assignUnitsUpdateRowFromUi(rowEl) {
  ...
  var costLineEl = rowEl.querySelector('.shoshin-assign-units-costline');
...
if (isOn && addQty > 0) {
  ...
  if (isDashState) {
    ...
    if (costLineEl) costLineEl.textContent = 'Total Cost: --';
    ...
    if (costLineEl) costLineEl.textContent = 'Total Cost: ' + String(assignUnitsGetPoints(a) * liveQty);
  ...
  return (
    ...
    '" data-filter-cls="' + esc(String(u.cls || u.class || u.className || '').trim()) + '">' +
      ...
      '<div class="shoshin-assign-units-mid">' +
        ...
        '<div class="shoshin-assign-units-costline"><strong>Total Cost:</strong> ' + esc(totalText0) + '</div>' +
      '</div>' +
