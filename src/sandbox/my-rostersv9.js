...
function maybeShowLockedModalFromJson(json) {
  try {
    ...
    if (json.locked === true || (json.ok === false && json.locked === true)) {
     openRmsLockedModal(json.msg || 'This item is locked because your Paid Membership term has ended and you are over the asset limit for the Free Membership Tier.<br><br>Only the newest item of the same type may be used.<br>(A page refresh may be required to update after asset deletion.)');
      return true;
    }
  } catch (e) {}
  return false;
