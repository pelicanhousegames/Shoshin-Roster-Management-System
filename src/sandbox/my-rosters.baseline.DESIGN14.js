...
.print-page.print-layout-2 .l2-hdr-left .l2-hdr-title{
  font-weight: 700;
  line-height: 1.05;
  font-size: 11px;       /* larger than table’s 8px body */
  display:flex;
...
/* Divider between tables — inherit exact bucket divider sizing */
.print-page.print-layout-2 .l2-between-tables{
  height: 12px;              /* total vertical height target */
  display:flex;
  align-items:center;
  justify-content:center;
  margin: 0;
...
.print-page.print-layout-2 .l2-between-buckets{
  height: auto;              /* let padding define total height */
  padding: 6px 0;            /* <-- add 6px top & bottom */
  display:flex;
  align-items:center;
  justify-content:center;
  margin: 0;
