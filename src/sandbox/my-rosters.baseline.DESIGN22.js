...
/* BEGIN SHOSHIN PRINT — L2 BUCKET→SEGMENT PAGINATION (TASK 3) */
/* BEGIN SHOSHIN PRINT — PROJECTION FIT (GAP-AWARE, SHARED L1/L2) */
'function projWillFit(addHeights, usedNow, countNow, availNow){' +
  ...
  'return u <= availNow;' +
'}' +
/* END SHOSHIN PRINT — PROJECTION FIT (GAP-AWARE, SHARED L1/L2) */
...
'if(__IS_L2__){' +
  ...
  'function __ensureMeas__(){' +
    ...
    'try{' +
      ...
      'document.body.appendChild(__MEAS__);' +
  ...
  // minimum viable segment = header + 1 row (implemented by count=1)
