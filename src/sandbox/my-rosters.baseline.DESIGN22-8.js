...
var turnSeqHtml =
  '<div class="qr-tight">' +
    ...
    '<div><b>Movement Phase:</b> Players alternate moving one unit at a time (by player order).</div>' +
    '<div><b>Action Phase:</b> Players alternate activating one unit to attack/use abilities/interact (by player order).</div>' +
...
var keyRulesHtml =
  '<div class="qr-tight">' +
    '<div><b>Movement:</b> Units cannot "pass through" and must move around one another.</div>' +
...
var col1 =
  '<div class="qr-col">' +
    ...
    outlineBlock('Movement Types', moveEngageHtml) +
