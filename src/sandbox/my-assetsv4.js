...
'Sailing Ships': { size: 'Medium', displayName: 'Wasen', description: '<em>Wooden Sailing Ship</em>' }
  ...
  Data.ABILITIES = {
    ...
    'Assassinate': { image: '/wp-content/uploads/2026/01/death2.jpg', capability: 'Assassinate', attributes: 'Permanently add +1 Damage and Critical hits bypass High Defense.' },
    ...
    'Aura of Resolve': { image: '/wp-content/uploads/2026/01/resolve2.jpg', capability: 'Aura of Resolve', attributes: 'All friendly units (including onmyoji) within 3" gain High Defense.' },
...
function renderAssignModeNote() {
  ...
  if (assignState.isDaimyoAsset) {
    ...
    var extraLockMsg = '';
    if (rosters.some(function (r) { return r && r.hasDaimyo; })) {
      extraLockMsg = lineHtml(
        '<span style="color:#c0392b; font-weight:700;">Some clans are unavailable because another Daimyo is already assigned.</span>'
      );
    }
    ...
    // State 5: THIS Daimyo assigned to ALL rosters (user may choose this pattern)
      ...
      mainMsg = lineHtml(
        '<strong style="color:#c0392b;">Restriction:</strong> ' +
        '<span style="color:#c0392b; font-weight:700;">This Daimyo is already assigned to all clans.</span>'
      );
