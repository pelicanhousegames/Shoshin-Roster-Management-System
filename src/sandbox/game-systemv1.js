...
(function() {
  ...
  // -----------------------------------------------------------------------------------
    ...
    armor: {
      'Do-maru': '/wp-content/uploads/2025/12/Basic1.jpeg',
      'O-yoroi': '/wp-content/uploads/2025/12/Great.jpeg',
      'Tosei-gusoku': '/wp-content/uploads/2025/12/Modern.jpeg'
    },
    ...
    var css = `
      ...
      #shoshin-training-table tbody td:nth-child(5) {
        ...
        text-align: center;
            ...
            /* ------------------------------------------------------------
         Ozutsu — Munitions Table (Header + Column Alignment)
         ------------------------------------------------------------ */
      ...
      /* ------------------------------------------------------------
         Support Assets — Rules Tables (prevent theme overlap / stacking)
         ------------------------------------------------------------ */
...
// END SHOSHIN PATCH — TASK2 TIER2_INFO.Tables
    ...
    'Support Assets': {
      'Ozutsu': 'Artillery and munitions support. Heavy battlefield tools with unique handling and pairing rules.',
...
Yokai: {
  ...
  var DEFAULT_CLASS_META = {
    ...
    Ozutsu: { size: 'Medium', displayName: 'Ozutsu', description: '<em>Lightweight Cannon</em>' },
  ...
  var DEFAULT_CLASS_IMAGES = {
    ...
    Ozutsu: '/wp-content/uploads/2026/02/ozutsu_colorized.jpg',
...
[
  ...
  var CLASS_RULES = {
    'Daimyo': {
      ...
      ranged: ['Shuriken', 'Fukiya', 'Hankyu', 'Daikyu', 'Tanegashima', 'Houroku-Hiya'],
    ...
    'Ninja': {
      ...
      ranged: ['Shuriken','Fukiya','Hankyu','Daikyu','Tanegashima','Kunai','Houroku-Hiya'],
      armor: ['Do-maru'],
  ...
  <table id="shoshin-armor-table" style="width:100%; border-collapse:collapse; font-size:0.8rem;">
    ...
    <tbody>
      ...
      >
        <td style="padding:4px 6px; border-bottom:1px solid #eee; text-align:center; vertical-align:middle;">
          <img
            src="/wp-content/uploads/2025/12/Basic1.jpeg"
            alt="Do-maru"
            style="width:32px; height:32px; object-fit:contain; display:block; margin:0 auto;"
          />
        </td>
      ...
      >
        <td style="padding:4px 6px; border-bottom:1px solid #eee; text-align:center; vertical-align:middle;">
          <img
            src="/wp-content/uploads/2025/12/Great.jpeg"
            alt="O-yoroi"
            style="width:32px; height:32px; object-fit:contain; display:block; margin:0 auto;"
          />
        </td>
      ...
      >
        <td style="padding:4px 6px; border-bottom:1px solid #eee; text-align:center; vertical-align:middle;">
          <img
            src="/wp-content/uploads/2025/12/Modern.jpeg"
            alt="Tosei-gusoku"
            style="width:32px; height:32px; object-fit:contain; display:block; margin:0 auto;"
          />
        </td>
    ...
    <tbody>
      ...
      <!-- Kayakujutsu -->
		...
		>
		  ...
		  <td style="padding:4px 6px; border-bottom:1px solid #eee; color:#555;">
			Tanegashima, Ozutsu<br>& Houroku-Hiya
		  </td>
		  <td style="padding:4px 6px; border-bottom:1px solid #eee; text-align:center;">
			2
		  </td>
...
<div id="shoshin-proficiency-wrapper">
  ...
  <p id="shoshin-proficiency-empty"
    ...
    munitions: `<!-- STEP 2 — Munitions Section (Hidden unless Ozutsu is selected) -->
...
<th style="border-bottom:1px solid #ccc; padding:4px 6px; text-align:center; white-space:nowrap;">Equipment</th>
    ...
    <tbody>
      <tr data-training="Kayakujutsu">
        ...
        <td style="padding:4px 6px; border-bottom:1px solid #eee; vertical-align:top; color:#555;">Tanegashima, Houroku-Hiya, Ozutsu</td>
...
<th style="border-bottom:1px solid #ccc; padding:4px 6px; text-align:left; width:320px; white-space:normal; overflow-wrap:anywhere; word-break:break-word;">Game Mechanic</th>
    ...
    <tbody>
      <tr>
        ...
        <td style="padding:4px 6px; border-bottom:1px solid #eee; vertical-align:top; color:#555;">At the start of the round, one or more engaged friendly units may form an Ozutsu detachment. Only units in this detachment may move, reload, or fire the cannon.</td>
      </tr>
      <tr>
        <td style="padding:4px 6px; border-bottom:1px solid #eee; vertical-align:top; color:#555;"><b>Collective Activation</b></td>
        <td style="padding:4px 6px; border-bottom:1px solid #eee; vertical-align:top; color:#555;">When the Ozutsu activates, the detachment moves and acts as a single unit, but each model in the detachment remains an individual target for attacks and effects.</td>
      </tr>
      <tr>
        <td style="padding:4px 6px; border-bottom:1px solid #eee; vertical-align:top; color:#555;"><b>Firing Arc &amp; Derived Stats</b></td>
        <td style="padding:4px 6px; border-bottom:1px solid #eee; vertical-align:top; color:#555;">The Ozutsu may only fire in the direction its muzzle faces at the end of the detachment’s movement. Attack and Movement are derived from the detachment’s engaged units, and Initiative checks use the highest Initiative among them.<br><b>One Operator:</b> Attack = 1 / Movement = 2".<br><b>Two Operators:</b> Attack = 2 / Movement = 4".</td>
      </tr>
    </tbody>
  </table>
</div>`,
...
baseTable.appendChild(baseColgroup);
  ...
  function buildArmory(kind) {
    ...
    if (kind === 'Melee Weapons') wrap.innerHTML = TABLES.meleeWeapons;
      ...
      wrap.innerHTML = TABLES.munitions + '<div style="margin-top:10px;"><em>Ozutsu base profile: coming from asset data (next pass).</em></div>';
...
function buildSupportAssets(kind) {
    ...
    if (kind === 'Ozutsu') {
      var cardO = buildSupportAssetCard('Ozutsu');
