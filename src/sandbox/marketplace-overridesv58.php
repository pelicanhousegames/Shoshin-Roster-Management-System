 ...
 * Uses existing pa_fulfillment => Batch Production logic
 * for Woo Blocks checkout.
 * ========================================================= */
...
if ( ! function_exists( 'shoshin_get_batch_ack_label' ) ) {
	function shoshin_get_batch_ack_label() {
		return 'I acknowledge that this order contains Batch Production items produced in scheduled group runs. Once the order is placed it cannot be canceled or refunded.';
	}
}
