    ...
    fetch(ajaxUrl, {
      ...
      .then(function (data) {
        ...
        if (row && payload.line_total_html) {
          ...
          var stack = priceWrap ? priceWrap.querySelector('.shoshin-mini-cart-price-stack') : null;

          if (stack) {
            var firstChild = stack.firstElementChild;
            if (firstChild) {
              firstChild.outerHTML = payload.line_total_html;
            } else {
