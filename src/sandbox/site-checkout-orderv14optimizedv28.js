...
function syncClassicCartExpressGate() {
  ...
  */
  ...
  function buildClassicCheckoutShell() {
    ...
    /* NOTES */
    if (notes) {
      var notesCard = wrapCard(notes, 'card-notes', 'Order Notes');
  ...
  function syncClassicCheckoutPaymentHeading() {
    ...
    var nativeHeading = notesCard.querySelector('.woocommerce-additional-fields > h3');
    if (nativeHeading) {
      nativeHeading.style.display = 'none';
    }
  }
  ...
  function syncClassicCheckoutAcknowledgementSection() {
    ...
    var shippingTotalsRow = document.querySelector(
      '#order_review tr.woocommerce-shipping-totals, ' +
      '#order_review tr.shipping'
    );

    var shippingMethodInput = document.querySelector(
    ...
    var requiresShipping = !!(shippingTotalsRow || shippingMethodInput);
