...
const tableKey = isVessel ? 'Wasen' : assetName; // preferred forward-facing key
    ...
    // Field visibility
    const fields = {
  vesselSize: { visible: (isVessel || isOzutsu), disabled: !(isVessel || isOzutsu), locked: false, reasons: !(isVessel || isOzutsu) ? ['asset_mismatch'] : [] },
  vesselDim:  { visible: (isVessel || isOzutsu), disabled: !(isVessel || isOzutsu), locked: false, reasons: !(isVessel || isOzutsu) ? ['asset_mismatch'] : [] },
...
function renderHiddenFields(model) {
  ...
  // Size + dimension (use selected text; match existing backend patterns)
