  ...
  function relocateClassicCoupon() {
    ...
    function setOpen(open) {
      ...
      existingPanel.classList.toggle('is-open', open);
        ...
        if (!couponForm.dataset.shoshinCheckoutCouponMoved) {
          body.appendChild(couponForm);
          body.appendChild(feedback);
          couponForm.dataset.shoshinCheckoutCouponMoved = '1';
        } else {
          if (body.lastElementChild !== feedback) {
            body.appendChild(feedback);
          }
        }
  ...
  function relocateClassicCheckoutCoupon() {
    ...
    function renderCouponNoticesFromDoc(doc) {
      ...
      notices.forEach(function (notice) {
        ...
        feedback.appendChild(notice.cloneNode(true));
        foundAny = true;
      });
