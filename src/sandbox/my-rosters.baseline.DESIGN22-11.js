...
var moveModsTable =
  '<table class="qr-mini">' +
    ...
    '<tbody>' +
      ...
      '<tr><td><b>Water<br>(Swim)</b></td><td>Small/Medium unarmored: −3&quot • Armored: requires Suieijutsu • Cavalry: max 4&quot • Large: halved • Huge+: unaffected • Enter: non-Suieijutsu must stop at edge first.</td></tr>' +
    '</tbody>' +
  '</table>';
...
var keyRulesHtml =
  '<div class="qr-tight">' +
    ...
    '<ul class="qr-ul">' +
      ...
      '<li>Disengaging may provoke a melee Opportunity Attack (if applicable).</li>' +
    '</ul>' +
...
var moraleHtml =
  '<div class="qr-tight">' +
    ...
    '</ul>' +
    '<div><b>Routed:</b> Sprint toward nearest table edge; no actions. Leaving the table grants XP. Test Morale each round until passed.</div>' +
  '</div>';
...
/* Tighten vertical real estate for landscape (8.5in tall) */
.print-page[data-print-layout="layout1-qr"] .qr-body{
  padding: 0.18in 0.22in 0.14in !important; /* was 0.24/0.24/0.20 */
}
...
/* Table cells: vertical-center already requested; do it here safely */
...
/* Conditions table is the tallest block—tighten it a hair more */
