...
var checked = (!isDisabled && ((curQtyForChecked > 0) || (stagedQtyForChecked > 0)));
// END RMS A3
...
var shouldDim =
  (!checked && (
    (curQty === 0) ||                 // dash rows (unassigned + toggle off)
    (isDisabled && !isCurrentlyAssigned) || // disabled + unassigned
    (isCurrentlyAssigned && !isDaimyoRow)   // assigned non-Daimyo rows look “already assigned” when OFF
  ));
