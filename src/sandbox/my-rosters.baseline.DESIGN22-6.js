...
function renderQuickReferenceCoreHTML(qr){
  ...
  var turnSeqHtml =
    '<ol class="qr-ol">' +
      '<li><b>Initiative Phase:</b> Recalculate total clan Initiative. Order = highest → lowest. Highest may choose to go last.</li>' +
      '<li><b>Movement Phase:</b> Players alternate moving 1 unit at a time (by Initiative order).</li>' +
      '<li><b>Action Phase:</b> Players alternate activating 1 unit to attack/use abilities/interact.</li>' +
  ...
  var moveEngageHtml =
    '<div class="qr-tight">' +
      '<div><b>March:</b> Move up to Movement.</div>' +
      '<div><b>Sprint:</b> Move up to 2× Movement; ends turn.</div>' +
      '<div><b>Charge:</b> Move up to 1.5× Movement to melee range; immediately make 1 melee attack at -1 To-Hit; ends turn.</div>' +
  ...
  var keyRulesHtml =
    '<div class="qr-tight">' +
      ...
      '<div class="qr-sp6"></div>' +
      '<div><b>Nighttime:</b> Games begin during daytime and alternates every two rounds.</div>' +
      '<div class="qr-sp6"></div>' +
      '<div><b>Disputes:</b> LOS/Cover/Targeting disputes = roll d6; highest result wins.</div>' +
...
var col1 =
  ...
  var combatResHtml =
    '<ol class="qr-ol">' +
      ...
      '<li><b>Friendly Fire:</b> Ranged Critical Miss + LOS passes through a single friendly: on a 1, that friendly is hit instead.</li>' +
    '</ol>';
...
.print-page[data-print-layout$="qr"] .qr-col{
  ...
  display: flex;
  flex-direction: column;
  gap: 10px; /* minimal whitespace between blocks */
  min-height: 0;
}
