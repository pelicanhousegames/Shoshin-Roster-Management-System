...
@media print{
  ...
  /* BEGIN SHOSHIN — PRINT FRAG HEIGHT LOCK */
.print-frag{
...
/* END SHOSHIN — PRINT FRAG HEIGHT LOCK */
...
/* NOTE: Update this path if your bg asset changes. */
:root{
  --print-bg-url: url("/wp-content/uploads/2026/01/bgtest.jpg");
}
