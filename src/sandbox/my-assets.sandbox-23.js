...
empty.innerHTML =
  ...
  '</div>';
      ...
      rostersToRender.forEach(function (r) {
        ...
        var effectiveQty = isSelected ? perRosterQty : existingQty;

        var basePts = parseInt(r && r.points ? r.points : 0, 10) || 0;
        var aPts = parseInt(asset && asset.points ? asset.points : 0, 10) || 0;

        // roster points after (remove old qty, add new qty)
        var afterPts = basePts - (aPts * existingQty) + (aPts * effectiveQty);
