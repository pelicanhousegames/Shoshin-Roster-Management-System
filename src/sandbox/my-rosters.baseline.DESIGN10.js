...
@media print{
  /* CRITICAL: zoom affects layout/pagination (unlike transform) */
  html, body{ width: var(--paper-w); height: var(--paper-h); }
  body{ zoom: var(--print-zoom); }

  .print-frag{
    width: var(--safe-w) !important;
    height: var(--safe-h) !important;
    margin: 0 auto !important;     /* centers within the physical page */
  }
}
