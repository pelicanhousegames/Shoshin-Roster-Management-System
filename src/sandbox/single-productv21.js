...
/* =========================================================
   ...
   Mirrors the near-working inline Woo JS approach
   ========================================================= */
(function ($) {
  'use strict';
  ...
  function shoshinOpenMenuCart() {
    var $main = $('.elementor-menu-cart__main').first();

    if ($main.length && $main.attr('aria-hidden') === 'false') {
      return;
    }
  ...
  $(document).on('submit', 'form.cart', function (e) {
    ...
    if ($form.data('shoshinSubmitting')) {
      e.preventDefault();
      return;
    }
