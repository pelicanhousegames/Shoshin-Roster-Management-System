...
function replaceFilterEverythingMarkup(doc) {
  ...
  var currentMainWrap = document.querySelector('.wpc-filters-main-wrap');
  var newMainWrap = doc.querySelector('.wpc-filters-main-wrap');

  if (currentMainWrap && newMainWrap) {
    currentMainWrap.innerHTML = newMainWrap.innerHTML;
    return;
  }

  var currentWidgetWrapper = document.querySelector('.wpc-filters-widget-wrapper');
  var newWidgetWrapper = doc.querySelector('.wpc-filters-widget-wrapper');
