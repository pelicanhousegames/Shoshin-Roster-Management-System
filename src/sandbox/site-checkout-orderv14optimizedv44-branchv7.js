...
function refreshSingleProductExpressState() {
  ...
  var payPalWraps = document.querySelectorAll('.single-product .ppc-button-wrapper, .single-product #ppcp-button, .single-product [id^="ppc-button-"]');
  var stripeWraps = document.querySelectorAll('.single-product #wc-stripe-express-checkout-element, .single-product .wcpay-express-checkout-wrapper');

  payPalWraps.forEach(function (el) {
    el.style.opacity = '';
