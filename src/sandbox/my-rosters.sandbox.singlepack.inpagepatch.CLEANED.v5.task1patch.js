...
function openPrintTabDocument(title, cssText, bodyHtml) {
  ...
  var EXTRA_PRINT_CSS =
    "\n/* BEGIN SHOSHIN TASK 1 — BASE FRAG CONTRACT (APPLIES IN PRINT TAB SCREEN + PRINT) */" +
    ...
    "\n/* END SHOSHIN TASK 1 — BASE FRAG CONTRACT (APPLIES IN PRINT TAB SCREEN + PRINT) */" +
...
for (var r = 0; r < rows.length; r++) {
  ...
  // Divider row (INSIDE pack)
  if (hasThumbHeader) body += dividerHtml;
