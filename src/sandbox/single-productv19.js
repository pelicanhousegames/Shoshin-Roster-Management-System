...
(function ($) {
  ...
  function confirmButtonState($button, text) {
    ...
    if ($button.data('shoshinSubmitting')) return;
  ...
  $(document.body).on('added_to_cart', function (event, fragments, cart_hash, $button) {
    ...
    /* -----------------------------------------
     ...
     Catch both click and submit so widget refresh cannot win
     ----------------------------------------- */
  $(document).on('click', '.single-product form.cart button.single_add_to_cart_button', function (e) {
    var $button = $(this);
