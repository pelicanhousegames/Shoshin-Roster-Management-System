...
empty.innerHTML =
  ...
  '</div>';
      ...
      <div class="shoshin-roster-main">
        ...
        <div class="shoshin-roster-metrics" style="display:flex; align-items:center; width:100%; min-width:0;">

          <div class="shoshin-roster-stats" style="flex:1 1 auto; min-width:0;">
                ...
                <tr>
                  ...
                  <td>
                    <div class="shoshin-stat-cell">
                      ...
                      <div class="shoshin-stat-value">${Core.esc(fmtWithDelta(r.ini, deltaIni))}</div>
                    </div>
                  </td>
          ...
          <!-- Grey vertical separator after HONOR -->
          <div class="shoshin-roster-assign-sep"
               style="width:1px; align-self:stretch; background:#d6d6d6; margin:0 10px;"></div>

          <!-- QTY cell (base when OFF, effective when ON) -->
          <div class="shoshin-roster-assign-qty"
               style="min-width:44px; text-align:right;">
            <div style="font-size:0.70rem; color:#777; font-weight:600; letter-spacing:0.02em;">QTY</div>
            <div style="font-size:0.95rem; font-weight:700; color:#444; line-height:1.1;">${Core.esc(qtyText)}</div>
          </div>

          <!-- % cell -->
          <div class="shoshin-roster-assign-pct"
               style="min-width:44px; text-align:right; margin-left:10px;">
            <div style="font-size:0.70rem; color:#777; font-weight:600; letter-spacing:0.02em;">%</div>
            <div style="font-size:0.90rem; font-weight:700; color:#555; line-height:1.1;">${Core.esc(pctText)}</div>
          </div>
