...
if (window.jQuery) {
  window.jQuery(document.body).on('update_checkout', function (e, args) {
    window.shoshinDebug('[WC] update_checkout', args || null, Date.now());
  });

  window.jQuery(document.body).on('updated_checkout', function (e, data) {
    window.shoshinDebug('[WC] updated_checkout', Date.now());
  });
}
...
jQuery(document.body).on('updated_checkout', function () {
  /*
    ...
    into the existing shell, then run the lighter sync helpers.
  */
  window.setTimeout(function () {
    syncClassicCheckoutCoreNodes();
    hydrateClassicCheckoutExpressCard();
