...
var col1 =
  ...
  '<td>—</td>' +
  '<td>Artillery, Sailing, Flight, Unitization & Collective Movement → see full rulebook for rules.</td>' +
'</tr>' +
...
.print-page[data-print-layout$="qr"] .qr-cols{
  ...
  margin-left: -12px;
  margin-right: -12px;
  margin-bottom: -24px; /* recoup bottom padding symmetrically */
}
...
.print-page[data-print-layout$="qr"] .qr-col{
  display: flex;
  flex-direction: column;
  justify-content: space-between; /* <- this is the distribution */
  height: 100%;
}
