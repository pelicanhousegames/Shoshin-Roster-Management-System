...
/* IMPORTANT: beat the tall-sheet SCREEN preview rules (which use !important) */
'\n.shoshin-print-measure .print-frag{' +
...
'\n.shoshin-print-measure .print-frag-inner{' +
...
'\n.shoshin-print-measure .print-frag-body{' +
...
/* BEGIN SHOSHIN PRINT — WAIT FOR MEASURE-MODE LAYOUT */
var _continue = arguments.callee && arguments.callee._continue;
if (!_continue) {
  // Defer the real pagination work until after the browser applies measure-mode styles.
  arguments.callee._continue = true;
  requestAnimationFrame(function(){
    requestAnimationFrame(function(){
      paginateAndSpaceEvenly(); // re-enter once layout is stable
    });
  });
  return;
}
/* END SHOSHIN PRINT — WAIT FOR MEASURE-MODE LAYOUT */
...
try {
  ...
  /* BEGIN SHOSHIN PRINT — MEASURE WAIT RESET */
  try { paginateAndSpaceEvenly._continue = false; } catch (_) {}
  /* END SHOSHIN PRINT — MEASURE WAIT RESET */
