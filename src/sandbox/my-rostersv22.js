...
function withInchesIfNumeric(v) {
  ...
  function makeUnitKey(u) {
    ...
    // Normalize Sailing Ships class for MVP:
    // Bulk Assign owned-assets may provide supportType="Wasen" (or subtype names) instead of cls="Sailing Ships".
    // unitKey MUST match assigned_units_json which uses cls="Sailing Ships".
    if (kind === 'support') {
