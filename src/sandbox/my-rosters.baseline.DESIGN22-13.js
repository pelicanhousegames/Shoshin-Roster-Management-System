...
var turnSeqHtml =
  '<div class="qr-tight">' +
    ...
    '<div><b>Resolve Conditions:</b> Resolve all active conditions (skip Round 1).</div>' +
...
var moveEngageHtml =
  '<table class="qr-mini">' +
    ...
    '<tbody>' +
      ...
      '<tr>' +
        '<td><b>Charge</b></td>' +
        '<td>Move up to 1.5× base Movement to melee range; immediately make 1 melee attack at -1 To-Hit; ends turn.</td>' +
      '</tr>' +
      '<tr>' +
        '<td><b>Climb</b></td>' +
...
var moveModsTable =
  '<table class="qr-mini">' +
    ...
    '<tbody>' +
      ...
      '<tr><td><b>Water<br>(Swim)</b></td><td>Small/Medium unarmored: −3&quot • Armored: requires Suieijutsu to move • Cavalry: max 4&quot • Large: halved • Huge+: unaffected • Enter terrain: non-Suieijutsu must end movement at edge first.</td></tr>' +
    '</tbody>' +
  '</table>';
...
.print-page[data-print-layout="layout1-qr"] .qr-cols{
  gap: 32px;                 /* keep your current column breathing room */
  margin-left: -16px;        /* reclaim width (matches earlier "push to edge" intent) */
  margin-right: -16px;
}
