...
(function () {
  ...
  // Used to override asset + roster images when a record is soft-locked.
  // IMPORTANT: do not move; requested to live next to fallback image path.
  const RMS_LOCK_ICON_URL = '/wp-content/uploads/2026/02/padlock.jpg';
  ...
  Data.CLASS_META = {
    ...
    Artillery: { size: 'Large', displayName: 'Taiho', description: '<em>Seige Cannon</em>' },
    'Sailing Ships': { size: 'Medium', displayName: 'Wasen', description: '<em>Wooden Sailing Ship</em>' }
  ...
  Data.PROFICIENCIES = {
    'Inept: Melee Combat': {
      image: '/wp-content/uploads/2026/01/Inept.jpg',
    ...
    'Ancestral Prestige': { image: '/wp-content/uploads/2026/01/ancestral.jpg', capability: 'Ancestral Prestige', attributes: 'May choose any armor at one-half points cost.' },
    'Martial Mastery': { image: '/wp-content/uploads/2026/01/swords.jpg', capability: 'Martial Mastery', attributes: 'May train any one proficiency for free.' },
    'Sword Master': { image: '/wp-content/uploads/2026/01/swordmaster.jpg', capability: 'Sword Master', attributes: 'Pays one-half points cost to train either Kenjutsu or Iaijutsu.' },
    'General Ineptitude': { image: '/wp-content/uploads/2026/01/Inept.jpg', capability: 'General Ineptitude', attributes: 'Pays double points cost to train any available proficiency.' },
    'Martial Artist': { image: '/wp-content/uploads/2025/12/Unarmed1.jpeg', capability: 'Martial Artist', attributes: 'Proficient in Jujutsu (free).' },
    'Polearms Adept': { image: '/wp-content/uploads/2026/01/polearmmaster.jpg', capability: 'Polearms Adept', attributes: 'Pays one-half points cost to train either Sojutsu or Naginatajutsu.' },
    'Espionage Expert': { image: '/wp-content/uploads/2025/12/Ninjutsu.jpeg', capability: 'Espionage Expert', attributes: 'Proficient in Ninjutsu (included).' },
    'Mysticism and Ritualism': { image: '/wp-content/uploads/2025/12/Sorcery.jpeg', capability: 'Mysticism and Ritualism', attributes: 'Proficient in Onmyodo (included).' }
  };

  Data.ABILITIES = {
    'Divine Inspiration': { image: '/wp-content/uploads/2026/01/martialmastery.jpg', capability: 'Divine Inspiration', attributes: 'All friendly clan units located within 2" receive +1 to all saving throws.' },
    'Honor Duel': { image: '/wp-content/uploads/2026/01/duel.jpg', capability: 'Honor Duel', attributes: 'May initiate an honor duel against an enemy samurai or daimyō.' },
    'Iron Fists': { image: '/wp-content/uploads/2026/01/fist.jpg', capability: 'Iron Fists', attributes: 'Unarmed combat deals damage to armor and stone.' },
    'Missile Deflection': { image: '/wp-content/uploads/2026/01/deflect2.jpg', capability: 'Missile Deflection', attributes: 'Spend an action to negate any non-firearm (arquebus, bombs, artillery) ranged attack once per round. Must be declared before an attack roll is made.' },
    'Ki Resilience': { image: '/wp-content/uploads/2026/01/ki.jpg', capability: 'Ki Resilience', attributes: 'Permanently add +1 Body.' },
    'Heal': { image: '/wp-content/uploads/2026/01/heal.jpg', capability: 'Heal', attributes: 'Spend an action to restore 1 Body and/or remove the Poison condition from any engaged unit, including yourself.' },
    'Wall Crawling': { image: '/wp-content/uploads/2026/01/rope.jpg', capability: 'Wall Crawling', attributes: 'May move upon any vertical surface as long as there is enough movement to end turn on a horizontal surface.' },
    'Light-footed': { image: '/wp-content/uploads/2026/01/agile.jpg', capability: 'Light-footed', attributes: 'Disengaging from an enemy does not provoke an opportunity attack.' },
    'Assassinate': { image: '/wp-content/uploads/2026/01/death2.jpg', capability: 'Assassinate', attributes: 'Permanently add +1 Damage and Critical hits bypass Resilience.' },
    'Shadow Strikes': { image: '/wp-content/uploads/2026/01/shadowstrikes.jpg', capability: 'Shadow Strikes', attributes: 'Permanently add +2 To-Hit during nighttime.' },
    'Concealment': {
      image: '/wp-content/uploads/2026/01/conceal.jpg',
    ...
    'Agile': { image: '/wp-content/uploads/2026/01/feet.jpg', capability: 'Agile', attributes: 'Permanently add +2 to base movement.' },
    'Aura of Resolve': { image: '/wp-content/uploads/2026/01/resolve2.jpg', capability: 'Aura of Resolve', attributes: 'All friendly units (including onmyoji) within 3" gain Resilience.' },
    'Omen of Wrath': { image: '/wp-content/uploads/2026/01/wrath.jpg', capability: 'Omen of Wrath', attributes: 'All friendly units (including onmyoji) within 3" gain +1 Attack.' },
    'Enduring Ward': { image: '/wp-content/uploads/2026/01/ward.jpg', capability: 'Enduring Ward', attributes: 'All friendly units (including onmyoji) within 3" gain +1 Defense.' },
    'Beyond the Veil': { image: '/wp-content/uploads/2026/01/Veil.jpg', capability: 'Beyond the Veil', attributes: 'Summon any Yokai up to 12" away with unobstructed line of sight.' }
  };
  ...
  Data.MELEE_WEAPONS = {
    ...
    'Kusarigama': { image: '/wp-content/uploads/2026/01/kusarigama.jpg', type: 'Sickle and Chain', attributes: '--' },
    'Kanabo': { image: '/wp-content/uploads/2026/01/kanabo.jpg', type: 'Studded War Club', attributes: 'Can damage Stone objects.' },
    'Yari': { image: '/wp-content/uploads/2025/12/Spear1.jpeg', type: 'Spear', attributes: 'Receives +1 To-Hit vs Cavalry units.' },
    'Katana': { image: '/wp-content/uploads/2026/01/katana.jpg', type: 'Sword', attributes: 'May decapitate Restrained units.' },
    ...
    'Nodachi': { image: '/wp-content/uploads/2026/01/nodachi.jpg', type: 'Great Sword', attributes: 'May decapitate Restrained units.' }
  };

  Data.RANGED_WEAPONS = {
    'Kunai': { image: '/wp-content/uploads/2026/01/kunai.jpg', type: 'Utility Tool', attributes: '<em>(Ninja only)</em>' },
    'Shuriken': { image: '/wp-content/uploads/2025/12/Shuriken1.jpeg', type: 'Throwing Stars', attributes: '--' },
    'Fukiya': { image: '/wp-content/uploads/2026/01/dart.jpg', type: 'Blowgun and Darts', attributes: '--' },
    'Hankyu': {
      image: '/wp-content/uploads/2026/01/hankyu.jpg',
      type: 'Half Bow',
      attributes: 'May be combined with Shirube.<br><strong>Extended Range:</strong> -1 To-Hit from 9" to 15".'
    },
    'Daikyu': {
      image: '/wp-content/uploads/2026/01/daikyu.jpg',
      type: 'Great Bow',
    ...
    'Ozutsu': {
      image: 'c',
      type: 'Handheld Cannon',
      attributes: 'Not a cavalry weapon.<br>Requires reload after use.'
    },
    'Houroku-Hiya': {
  ...
  Data.ARMOR = {
    'Do-maru': { image: '/wp-content/uploads/2026/04/do_maru.webp', type: 'Basic Armor', attributes: 'Permanently gain +1 Defense.' },
    'O-yoroi': { image: '/wp-content/uploads/2026/04/o_yoroi.webp', type: 'Great Armor', attributes: 'Permanently gain +2 Defense.' },
    'Tosei-gusoku': { image: '/wp-content/uploads/2026/04/tosei_gusoku.webp', type: 'Modern Armor', attributes: 'Permanently gain +3 Defense.' }
  };
  ...
  Data.TRAINING = {
    ...
    'Kusarigamajutsu': { image: '/wp-content/uploads/2026/01/kusarigama.jpg', ryu: 'Kusarigamajutsu', discipline: 'Sickle and Chain', equipment: 'Kusarigama' },
    'Mojirijutsu': { image: '/wp-content/uploads/2026/01/kanabo.jpg', ryu: 'Mojirijutsu', discipline: 'Studded War Club', equipment: 'Kanabo' },
    'Sojutsu': { image: '/wp-content/uploads/2025/12/Spear1.jpeg', ryu: 'Sojutsu', discipline: 'Spear', equipment: 'Yari' },
    'Kenjutsu': { image: '/wp-content/uploads/2026/01/katana.jpg', ryu: 'Kenjutsu', discipline: 'Sword', equipment: 'Katana' },
    ...
    'Iaijutsu': { image: '/wp-content/uploads/2026/01/nodachi.jpg', ryu: 'Iaijutsu', discipline: 'Great Sword', equipment: 'Nodachi' },
    ...
    'Fukumibarijutsu': { image: '/wp-content/uploads/2026/01/dart.jpg', ryu: 'Fukumibarijutsu', discipline: 'Blowgun & Darts', equipment: 'Fukiya' },
    'Kyujutsu': { image: '/wp-content/uploads/2026/01/kyujutsu.jpg', ryu: 'Kyujutsu', discipline: 'Bows', equipment: 'Hankyu, Daikyu' },
    'Kayakujutsu': { image: '/wp-content/uploads/2025/12/Arquebus1.jpeg', ryu: 'Kayakujutsu', discipline: 'Gunpowder Firearms & Explosives', equipment: 'Tanegashima, Houroku-Hiya, Ozutsu, Taiho' },
    'Hojojutsu': { image: '/wp-content/uploads/2025/12/Rope.jpeg', ryu: 'Hojojutsu', discipline: 'Arresting Rope', equipment: 'Torinawa' },
    'Suieijutsu': { image: '/wp-content/uploads/2025/12/Water.jpeg', ryu: 'Suieijutsu', discipline: 'Water Combat', equipment: 'Wasen' },
  ...
  function initMyAssetsRenderer() {
    ...
    const wrapperEl = listEl.closest('.shoshin-asset-list-wrapper') || listEl.parentElement;
        ...
        /* BEGIN RMS SOFT LOCK — GENERIC LOCKED MODAL (My Assets) */
    let rmsLockedModal = null;
    let rmsLockedBackdrop = null;
...
/* BEGIN RMS SOFT LOCK — LOCKED MODAL MARKUP (My Assets) */
rmsLockedModal.innerHTML = `
  ...
  <div class="shoshin-modal-body shoshin-preview-body-wrap">
    ...
    <h2 id="shoshin-rms-locked-title" style="margin-top:0;">
      Locked
    </h2>

    <!-- Meta row -->
    <div class="shoshin-preview-asset-row"
         style="margin-top:12px; display:flex; align-items:center; gap:16px;">

      <img class="shoshin-preview-asset-img shoshin-rms-locked-img"
           src="${Core.esc(RMS_LOCK_ICON_URL)}"
           alt="Locked"
           style="
             width:96px;
             height:96px;
      ...
      <div style="
        ...
        <div class="shoshin-preview-asset-ref shoshin-rms-locked-ref"
             style="opacity:0.85; margin-top:4px;">
        </div>
      </div>

    </div>

    <div class="shoshin-modal-msg"
         style="margin:14px 0 0; line-height:1.4;">
    </div>
    ...
    <div class="shoshin-modal-footer">
      <button type="button"
              class="shoshin-modal-btn shoshin-modal-btn-cancel">
        Close
      </button>
    </div>
...
`;
/* END RMS SOFT LOCK — LOCKED MODAL MARKUP (My Assets) */
      ...
      const xBtn = rmsLockedModal.querySelector('.shoshin-modal-x');
      if (xBtn) xBtn.addEventListener('click', close);
      const okBtn = rmsLockedModal.querySelector('.shoshin-modal-btn-cancel');
...
/* BEGIN RMS SOFT LOCK — OPEN LOCKED MODAL WITH META (My Assets) */
function openRmsLockedModal(msg, ctx) {
  ...
  // Defaults
  var kind = (ctx && ctx.kind) ? String(ctx.kind) : '';
  var name = (ctx && (ctx.displayName || ctx.cls || ctx.type)) ? String(ctx.displayName || ctx.cls || ctx.type) : 'Locked Item';
  var ref  = (ctx && ctx.refId) ? String(ctx.refId) : '';

  // Title logic
  if (titleEl) {
    if (kind === 'roster') titleEl.textContent = 'Locked Roster';
    else titleEl.textContent = 'Locked Asset';
  }

  // Meta
  if (nameEl) nameEl.textContent = name;
  if (refEl)  refEl.textContent = ref ? ref : '';
  if (imgEl)  imgEl.setAttribute('src', RMS_LOCK_ICON_URL);
...
/* END RMS SOFT LOCK — OPEN LOCKED MODAL WITH META (My Assets) */

    // Detect backend-first lock response: { ok:false, locked:true, msg:"..." }
    function maybeShowLockedModalFromJson(json) {
      try {
        if (!json) return false;
        if (json.locked === true || (json.ok === false && json.locked === true)) {
          openRmsLockedModal(json.msg || 'Over Free-tier limit...');
          return true;
        }
      } catch (e) {}
      return false;
    }
    /* END RMS SOFT LOCK — GENERIC LOCKED MODAL (My Assets) */
    ...
    function ajaxDeleteEntry(entryId, extra) {
      return new Promise(function (resolve, reject) {
        const cfg = window.ShoshinAjax || window.ShoshinRosterAjax || {};
...
if (ref) ref.textContent = Core.esc(assetCtx && assetCtx.refId ? assetCtx.refId : '—');
  ...
  return new Promise(function (resolve) {
    ...
    fetch(ajaxUrl, {
      ...
      .then(function (r) {
        return parseAjaxResponse(r).then(function (info) {
                    /* BEGIN RMS SOFT LOCK — INTERCEPT LOCKED RESPONSE (fetchMyRosters) */
          if (maybeShowLockedModalFromJson(info.json)) {
            resolve([]);
            return;
          }
          /* END RMS SOFT LOCK — INTERCEPT LOCKED RESPONSE (fetchMyRosters) */
  ...
  return new Promise(function (resolve, reject) {
    ...
    fetch(ajaxUrl, {
      ...
      .then(function (r) {
        return parseAjaxResponse(r).then(function (info) {
                    /* BEGIN RMS SOFT LOCK — INTERCEPT LOCKED RESPONSE (assign) */
          if (maybeShowLockedModalFromJson(info.json)) {
            // Treat as blocked with no-op update; keep UI stable
            resolve({ updatedRosterIds: [] });
            return;
          }
          /* END RMS SOFT LOCK — INTERCEPT LOCKED RESPONSE (assign) */
          if (info.json && info.json.success === true) {
  ...
  let img = Core.firstNonEmptyString(r.img, r.image, r.imageUrl, r.image_url, FALLBACK_IMAGE) || FALLBACK_IMAGE;

// If roster is locked, force padlock image
if (r && (r.locked === true || String(r.locked) === '1')) {
  ...
  hasDaimyo = arr.some(function (u) {
    ...
    return cls === 'Daimyo' || name2 === 'Daimyo';
          ...
          '';
              ...
              // RMS lock flag (may come through under different keys depending on endpoint/version)
      var lockedRaw =
        (r && (r.locked != null)) ? r.locked :
        (r && (r.rms_locked != null)) ? r.rms_locked :
        (r && (r.rmsLocked != null)) ? r.rmsLocked :
        (r && (r.is_locked != null)) ? r.is_locked :
        (r && (r.isLocked != null)) ? r.isLocked :
        (r && (r.soft_locked != null)) ? r.soft_locked :
        (r && (r.softLocked != null)) ? r.softLocked :
        (r && (r.rms_is_locked != null)) ? r.rms_is_locked :
        (r && (r.rmsIsLocked != null)) ? r.rmsIsLocked :
        null;

      var locked = false;
      if (lockedRaw === true || lockedRaw === 1 || lockedRaw === '1') locked = true;
      else if (typeof lockedRaw === 'string' && lockedRaw.trim().toLowerCase() === 'true') locked = true;
...
<div class="shoshin-preview-asset-ref shoshin-assign-asset-ref">—</div>
      ...
      try {
        ...
        // Type:
        // - Characters: show class (e.g., Ashigaru, Samurai)
        // - Support assets: keep display name (e.g., Ozutsu)
        let typeText = '—';
        if (assetCtx) {
          const kind = String(assetCtx.kind || '').trim();
          const clsKey = String(assetCtx.cls || assetCtx.class || assetCtx.className || '').trim();
          const nameKey = String(assetCtx.name || '').trim();

          if (kind === 'character') {
            typeText = clsKey || nameKey || '—';
          } else {
            typeText = nameKey || clsKey || '—';
          }
        }

        if (cls) cls.textContent = typeText;

        // REF ID — value only (label removed)
        if (ref) ref.textContent = assetCtx && assetCtx.refId ? String(assetCtx.refId) : '—';

        // Total Cost (unchanged behavior, safe string concat)
        if (cost) {
          cost.innerHTML =
            '<strong>Unit Cost:</strong> ' +
            Core.esc(String(assetCtx && assetCtx.points ? assetCtx.points : 0));
        }
      } catch (_) {}
      ...
      // Do NOT focus the Close X on open (it appears "active"). Focus the modal container instead.
      try {
        previewModal.focus();
      } catch (_) {}
    ...
    function getRosterAssignedUnitsArray(r) {
      try {
        ...
        if (rawAssigned && typeof rawAssigned === 'string') {
          ...
          // WPForms-style: { id: 9, value: "[...json...]" }
          if (rawAssigned.value && typeof rawAssigned.value === 'string') {
            try { arr = JSON.parse(String(rawAssigned.value)); } catch (_) { arr = null; }
          }
  ...
  (allRosters || []).forEach(function (r) {
    ...
    const totalPts = parseInt(rosterPoints, 10) || 0;
    const partPts  = parseInt(assignedCost, 10) || 0;
    const pct = (totalPts > 0 && partPts > 0) ? Math.round((partPts / totalPts) * 100) : 0;
  ...
  return out;
    ...
    function renderPreviewRosterList() {
      ...
      if (!assignedAll.length) {
        ...
        // Render empty state INSIDE the list area so it is always visible
        list.innerHTML =
          '<div class="shoshin-assets-empty shoshin-asset-empty-state" style="padding:10px 4px; text-align:center;">' +
            '<h2 style="margin:0; font-size:1.1rem; color:#777; font-weight:400;">There are currently no clan rosters this unit is assigned to.</h2>' +
            '<img ' +
              'src="/wp-content/uploads/2025/11/SPOA.webp" ' +
              'alt="Shoshin illustration" loading="lazy" ' +
              'style="display:block !important; margin:10px auto 0 !important; max-width:150px !important; width:100% !important; height:auto !important;"' +
            '/>' +
          '</div>';

        // Keep legacy empty blocks hidden/cleared
        emptyGlobal.style.display = 'none';
      ...
      if (!filtered.length) {
        ...
        // Render filter-empty state INSIDE the list area so it is visible in the modal
        list.innerHTML =
          '<div class="shoshin-assets-empty shoshin-asset-empty-state" style="padding:10px 4px; text-align:center;">' +
            '<h2 style="margin:0; font-size:1.1rem; color:#777; font-weight:400;">No assignments to any clan rosters within this points range.</h2>' +
            '<img ' +
              'src="/wp-content/uploads/2025/11/SPOA.webp" ' +
              'alt="Shoshin illustration" loading="lazy" ' +
              'style="display:block !important; margin:10px auto 0 !important; max-width:150px !important; width:100% !important; height:auto !important;"' +
      ...
      filtered.forEach(function (x) {
        var r = x.roster;
                ...
                var unitPts = 0;
        try {
          unitPts = parseInt(previewState && previewState.asset && previewState.asset.points, 10);
          if (!isFinite(unitPts)) unitPts = 0;
        } catch (_) { unitPts = 0; }

        var q = 0;
        try {
          q = parseInt(x && x.qty, 10);
          if (!isFinite(q) || q < 0) q = 0;
        } catch (_) { q = 0; }

        var totalCost = unitPts * q;
...
<div class="shoshin-roster-ref">${r.refId ? Core.esc(r.refId) : ''}</div>
<div class="shoshin-assign-units-costline"><strong>Total Cost:</strong> ${Core.esc(String(totalCost))}</div>
    ...
    function ensureAssignModal() {
      ...
      assignModal.classList.add('shoshin-assign-modal');
            ...
            // ------------------------------------------------------------
      // Assign modal patch: prevent any background/highlight on the % cell
      // (some themes/CSS rules apply td:hover backgrounds that become visible
      // once the % cell layout changes)
      // ------------------------------------------------------------
      (function injectAssignPctBgFix() {
        var styleId = 'shoshin-assign-pct-bgfix';
        if (document.getElementById(styleId)) return;

        var st = document.createElement('style');
        st.id = styleId;
        st.textContent =
          '.shoshin-assign-modal .shoshin-stat-strip td.shoshin-stat-pct, ' +
          '.shoshin-assign-modal .shoshin-stat-strip td.shoshin-stat-pct:hover, ' +
          '.shoshin-assign-modal .shoshin-stat-strip td.shoshin-stat-pct:active, ' +
          '.shoshin-assign-modal .shoshin-stat-strip td.shoshin-stat-pct:focus { ' +
...
`;
      ...
      if (modeToggle) {
        ...
        if (!modeToggle.__shoshinBound) {
  modeToggle.__shoshinBound = true;
...
function renderAssignModeNote() {
  ...
  if (assignState.isDaimyoAsset) {
    ...
    for (var i = 0; i < rosters.length; i++) {
      var rr = rosters[i];
      if (rr && !rr.hasDaimyo) availableCount++;
    }

    // Determine whether THIS asset is already assigned to 1+ rosters.
    // IMPORTANT: match by entryId first (stable), then fall back to refId.
    var wantRefId = '';
    var wantEntryId = 0;
    ...
    try {
      wantEntryId = parseInt(assignState.asset && assignState.asset.entryId ? assignState.asset.entryId : 0, 10) || 0;
    } catch (_) { wantEntryId = 0; }

    function lineHtml(inner) {
      return '<div style="margin:0; padding:0;">' + inner + '</div>';
    }

    // Always show this FIRST when Daimyo=true
    var qtyLockMsg = lineHtml(
      '<strong style="color:#c0392b;">Restriction:</strong> ' +
      '<span style="color:#c0392b; font-weight:700;">Daimyo quantity selector is locked to One \u2192 Many.</span>'
    );

    // Unified hint: some rosters may be disabled because ANOTHER Daimyo is already assigned
    var extraLockMsg = '';
        if (rosters.length > 1 && rosters.some(function (r) { return r && r.hasDaimyo; })) {
      extraLockMsg = lineHtml(
        '<span style="color:#c0392b; font-weight:700;">Some clans are unavailable because a Daimyo is already assigned to it.</span>'
      );
    }

    function rosterHasThisAsset(r) {
      try {
        if (!r) return false;
        ...
        try {
          if (Array.isArray(raw)) {
            ...
            arr = JSON.parse(String(raw.value));
          } else {
            arr = [];
          }
        } catch (_) {
        ...
        for (var ui = 0; ui < arr.length; ui++) {
          ...
          // Prefer entryId match
          if (wantEntryId > 0) {
            var uEid = parseInt(u.entryId || u.entry_id || 0, 10) || 0;
            if (uEid === wantEntryId) return true;
          }

          // Fallback: refId match
          if (wantRefId) {
            if (String(u.refId || '').trim() === wantRefId) return true;
          }
        }
    ...
    var assignedThisCount = 0;
    for (var rc = 0; rc < rosters.length; rc++) {
      if (rosterHasThisAsset(rosters[rc])) assignedThisCount++;
    }

    var totalRosters = rosters.length;
    var assignedToAllRosters = (totalRosters > 0 && assignedThisCount === totalRosters);
    var noRostersAvailable = (availableCount === 0);

    var mainMsg = '';

    // State 1: THIS Daimyo assigned to some, and at least one roster is still available
    if (assignedThisCount > 0 && !noRostersAvailable) {
      mainMsg = lineHtml(
        '<strong style="color:#c0392b;">Restriction:</strong> ' +
        '<span style="color:#c0392b; font-weight:700;">This Daimyo is already assigned to one or more clans.</span>'
      );

    // State 5: THIS Daimyo assigned to ALL rosters (user may choose this pattern)
    } else if (assignedToAllRosters) {
      mainMsg = lineHtml(
        '<strong style="color:#c0392b;">Restriction:</strong> ' +
        '<span style="color:#c0392b; font-weight:700;">This Daimyo is already assigned to all available clans.</span>'
      );

    // NEW STATE: No rosters available because every clan already has SOME Daimyo (not necessarily THIS one)
    } else if (noRostersAvailable) {
      mainMsg = lineHtml(
        '<strong style="color:#c0392b;">Restriction:</strong> ' +
        '<span style="color:#c0392b; font-weight:700;">No clans are available because each clan already has an assigned Daimyo.</span>'
      );

    // State 3: THIS Daimyo not assigned anywhere, and at least one roster is available
    } else {
      mainMsg = lineHtml(
        '<strong style="color:#c0392b;">Restriction:</strong> ' +
        '<span style="color:#c0392b; font-weight:700;">Only one Daimyo is allowed to be assigned per clan.</span>'
      );
    }

    noteEl.innerHTML = qtyLockMsg + mainMsg + extraLockMsg;

  } else if (assignState.mode === 'one_to_many') {
    noteEl.innerHTML =
      '<strong style="color:#c0392b;">One \u2192 Many:</strong> ' +
      '<span style="color:#c0392b; font-weight:700;">Quantity is locked to 1 but can be assigned to multiple rosters.</span>';
  } else {
    noteEl.innerHTML =
      '<strong style="color:#c0392b;">Many \u2192 One:</strong> ' +
      '<span style="color:#c0392b; font-weight:700;">Quantity is adjustable but can only be assigned to a single roster.</span>';
  }
  ...
  showAssignInlineError('');
    ...
    function updateQtyUI() {
      ...
      if (assignState.mode === 'one_to_many') {
        ...
        function updateAssignCostUI() {
      if (!assignModal) return;

      const costEl = assignModal.querySelector('.shoshin-assign-asset-cost');
      if (!costEl) return;

      const a = assignState.asset || {};

      let base = 0;
      try {
        base = parseInt(a.points, 10);
        if (!isFinite(base)) base = 0;
      } catch (_) { base = 0; }

      // Only multiply by qty in Many → One mode (in One → Many qty is effectively 1)
      let q = 1;
      if (assignState.mode === 'many_to_one') {
        q = parseInt(assignState.qty, 10);
        if (!isFinite(q) || q < 1) q = 1;
      }

      const total = base * q;
      costEl.innerHTML = '<strong>Total Cost:</strong> ' + Core.esc(String(total));
    }
  ...
  '</div>';
      ...
      function fmtWithDelta(base, delta) {
        ...
        return String(b + d);
            ...
            // Determine whether THIS asset is already assigned to a given roster by scanning assigned_units_json.
      // This is used only for visual dimming (does NOT change selection semantics).
      var wantRefId = '';
      try {
        wantRefId = String(assignState.asset && assignState.asset.refId ? assignState.asset.refId : '').trim();
      } catch (_) { wantRefId = ''; }

      function rosterHasThisAssetAssigned(r) {
        if (!wantRefId || !r) return false;
      ...
      rostersToRender.forEach(function (r) {
        var isSelected = assignState.selectedRosterIds.has(r.entryId);
                ...
                // Visual state: keep rows greyed-out unless selected OR already assigned
        var hasExistingAssignment = rosterHasThisAssetAssigned(r);
        ...
        /* BEGIN RMS SOFT LOCK — DISABLE LOCKED ROSTERS (Assign modal roster list) */
                var isRmsLocked = rmsIsLocked(r);

        // Safety: ensure a locked roster can never remain selected
        if ((isDaimyoLocked || isRmsLocked) && isSelected) {
          assignState.selectedRosterIds.delete(r.entryId);
          isSelected = false;
        }
        /* END RMS SOFT LOCK — DISABLE LOCKED ROSTERS (Assign modal roster list) */
        ...
        var deltaHonor = (asset.honor || 0) * perRosterQty;
                ...
                // ------------------------------------------------------------
        // Roster initiative normalization (assets modal)
        // /my-rosters may provide initiative under different keys.
        // Keep support for legacy + current payloads.
        // ------------------------------------------------------------
        var rosterIni =
          (r && r.ini != null) ? r.ini :
          (r && r.ini_total != null) ? r.ini_total :
          (r && r.initiative != null) ? r.initiative :
          (r && r.iniTotal != null) ? r.iniTotal :
          (r && r.totalIni != null) ? r.totalIni :
          0;


        // ------------------------------------------------------------
        // % of roster points (for this asset on this roster row)
        // - If toggle ON: reflect the post-save qty for this roster (perRosterQty)
        // - If toggle OFF: reflect existing assignment qty (if any)
        // - Rounding matches /my-rosters row3 behavior (Math.round)
        // ------------------------------------------------------------
        var existingQty = 0;
        try {
          var wantRefId2 = String(asset && asset.refId ? asset.refId : '').trim();
          var raw2 = (r && (r.assigned_units_json != null ? r.assigned_units_json : (r.assigned || r.assignedUnitsJson || ''))) || '';
          if (wantRefId2 && raw2) {
            var arr2 = [];
            try { arr2 = Array.isArray(raw2) ? raw2 : JSON.parse(String(raw2)); } catch (_) { arr2 = []; }
            if (Array.isArray(arr2) && arr2.length) {
              for (var qi = 0; qi < arr2.length; qi++) {
                var u2 = arr2[qi];
                if (!u2) continue;
                if (String(u2.refId || '').trim() === wantRefId2) {
                  existingQty = parseInt(u2.qty || 0, 10) || 0;
                  break;
                }
              }
            }
          }
        } catch (_) { existingQty = 0; }

        // Determine final qty for this roster row (pre-save preview)
        // - one_to_many: perRosterQty means "add N"
        // - many_to_one: perRosterQty means "set to N"
        var isOneToMany = (assignState && assignState.mode === 'one_to_many');

        // PREVIEW RULE (unified): selector represents "add N" for BOTH modes
        // If roster already has qty=1 and user selects 2, preview becomes 3.
        var effectiveQty = existingQty;
        var deltaQty = 0;

        if (isSelected) {
          effectiveQty = existingQty + perRosterQty;
          deltaQty = perRosterQty;
        }

        var basePts = parseInt(r && r.points ? r.points : 0, 10) || 0;
        var aPts = parseInt(asset && asset.points ? asset.points : 0, 10) || 0;


        var afterPts = basePts + (aPts * deltaQty);
        if (afterPts < 0) afterPts = 0;

        var partPts = aPts * effectiveQty;

        // Show base QTY when toggle OFF; show effective (pre-save) QTY when toggle ON
        var qtyText = String(parseInt(effectiveQty, 10) || 0);

        var pctVal = (afterPts > 0 && partPts > 0) ? Math.round((partPts / afterPts) * 100) : 0;
        var pctText = String(pctVal) + '%';
        ...
        row.className = 'shoshin-assign-roster-row';
                ...
                // Grey-out unless toggle is ON OR assignment already exists.
        // Note: disabled rows stay visually dim unless they already have this asset assigned.
        var isActiveRow = !!(isSelected || hasExistingAssignment);

        if (!isActiveRow) {
          row.style.opacity = '0.45';
          row.style.filter = 'grayscale(70%)';

          // Locked rosters: do NOT show hover (prevents "looks selectable" confusion)
          // Also provide an explicit reason via tooltip/cursor.
          if (isDaimyoLocked) {
            row.style.cursor = 'not-allowed';
            row.title = 'Unavailable: this clan already has a Daimyo assigned.';
          } else if (isRmsLocked) {
            row.style.cursor = 'not-allowed';
            row.title = 'Unavailable: this roster is locked due to RMS Free Tier limits.';
          } else {
            row.style.cursor = 'pointer';

            // Optional hover affordance for discoverability
            row.addEventListener('mouseenter', function () {
              row.style.opacity = '0.75';
              row.style.filter = 'grayscale(20%)';
            });
      ...
      <div class="shoshin-roster-left">
        ...
        <img class="shoshin-roster-avatar"
                          src="${Core.esc(rmsPickImg((r.img || FALLBACK_IMAGE), isRmsLocked))}"
             alt="Roster image"
             loading="lazy">
      </div>
      ...
      <div class="shoshin-roster-main">
        <div class="shoshin-roster-title">
          ...
          <div class="shoshin-roster-ref">${r.refId ? Core.esc(r.refId) : ''}</div>
                ...
                <div class="shoshin-roster-metrics" style="width:100%; min-width:0;">

          <div class="shoshin-roster-stats" style="width:100%; min-width:0;">
            <table class="shoshin-stat-strip" style="table-layout:fixed; width:100%;">
              <tbody>
                <tr>
                  <td>
                    <div class="shoshin-stat-cell">
                      <div class="shoshin-stat-label">POINTS</div>
                      <div class="shoshin-stat-value">${Core.esc(fmtWithDelta(r.points, deltaPoints))}</div>
                    </div>
                  </td>
                  ...
                  <td>
                    <div class="shoshin-stat-cell">
                      <div class="shoshin-stat-label">UNITS</div>
                      <div class="shoshin-stat-value">${Core.esc(fmtWithDelta(r.units, deltaUnits))}</div>
                    </div>
                  </td>

                  <td>
                    <div class="shoshin-stat-cell">
                      <div class="shoshin-stat-label">INI</div>
                      <div class="shoshin-stat-value">${Core.esc(fmtWithDelta(rosterIni, deltaIni))}</div>
                  ...
                  <td>
                    <div class="shoshin-stat-cell">
                      <div class="shoshin-stat-label">HONOR</div>
                      <div class="shoshin-stat-value">${Core.esc(fmtWithDelta(r.honor, deltaHonor))}</div>
                    </div>
                  </td>

                  <!-- QTY (with vertical separator after HONOR) -->
                  <td style="border-left:1px solid #d6d6d6;">
                    <div class="shoshin-stat-cell">
                      <div class="shoshin-stat-label">QTY</div>
                      <div class="shoshin-stat-value">${Core.esc(qtyText)}</div>
                    </div>
                  </td>

<!-- % (vertically centered, no visible label) -->
<td class="shoshin-stat-pct">

  <div class="shoshin-stat-cell"
       style="display:flex; flex-direction:column; justify-content:center; height:100%;">
    <div class="shoshin-stat-label" style="display:none;">%</div>
    <div class="shoshin-stat-value" style="line-height:1;">
      ${Core.esc(pctText)}
    </div>
  </div>
</td>
    ...
    `;
        ...
        if (assignState.isDaimyoAsset && r.hasDaimyo) {
          if (cb) {
            cb.disabled = true;
            if (cb.style) cb.style.cursor = 'not-allowed';
          }
          ...
          if (wrap) {
            ...
            // Cursor: show "not allowed" on the whole toggle control
            if (wrap.style) wrap.style.cursor = 'not-allowed';

            // Also apply cursor to the visible slider span (what users actually hover)
            var slider = wrap.querySelector('.shoshin-ios-slider');
            if (slider && slider.style) slider.style.cursor = 'not-allowed';
          }

          row.classList.add('shoshin-roster-daimyo-locked');
        }

        /* BEGIN RMS SOFT LOCK — DISABLE TOGGLE + STYLE (locked rosters) */
        if (isRmsLocked) {
          if (cb) {
            cb.disabled = true;
            if (cb.style) cb.style.cursor = 'not-allowed';
          ...
          var wrap2 = row.querySelector('.shoshin-ios-toggle');
          if (wrap2) {
            wrap2.classList.add('is-disabled', 'is-rms-locked');

            // Cursor: show "not allowed" on the whole toggle control
            if (wrap2.style) wrap2.style.cursor = 'not-allowed';

            // Also apply cursor to any visible slider span
            var slider2 = wrap2.querySelector('.shoshin-ios-slider');
            if (slider2 && slider2.style) slider2.style.cursor = 'not-allowed';
          }

          row.classList.add('shoshin-roster-rms-locked');
        }
        /* END RMS SOFT LOCK — DISABLE TOGGLE + STYLE (locked rosters) */
    ...
    function openAssignModal(assetCtx) {
      ...
      if (modeToggle) {
        ...
        // Cursor: show "not allowed" for Daimyo-locked mode toggle
        if (sw && sw.style) {
          sw.style.cursor = assignState.isDaimyoAsset ? 'not-allowed' : '';
        }
        if (modeToggle && modeToggle.style) {
          modeToggle.style.cursor = assignState.isDaimyoAsset ? 'not-allowed' : '';
        }
      }
  ...
  // Type: match /my-assets card behavior
// - Support assets: show the instance display name (e.g., "Ozutsu", "Kobaya", "Sekibune")
// - Characters: show the character class key (e.g., "Onmyoji", "Ashigaru")
let typeText = '—';
if (assetCtx) {
  const clsKey = String(assetCtx.cls || '').trim();

  if (assetCtx.kind === 'support') {
    // Prefer the instance name we already captured from the card (subtype-safe)
    const instName = assetCtx.name ? String(assetCtx.name).trim() : '';
    if (instName) {
      typeText = instName;
    } else {
      const metaMap = (Data && (Data.CLASS_META || Data.CLASS_INFO)) ? (Data.CLASS_META || Data.CLASS_INFO) : null;
    ...
    typeText = clsKey || '—';
        ...
        // REF ID label removed (value only)
        if (ref) ref.textContent = assetCtx && assetCtx.refId ? String(assetCtx.refId) : '—';
...
function closeAssignModal() {
      ...
      // Reset Assign Modal transient state on close
      // - Qty selector back to 1
      // - Many -> One toggle back to OFF
      try {
...
if (modeToggle) modeToggle.checked = false;
  ...
  show = (kind === 'support') || (cardClass === 'Artillery' || cardClass === 'Sailing Ships'); // fallback
} else {
  show = cardClass === filterLabel;
    ...
    /* BEGIN RMS SOFT LOCK — AUTO-UNLOCK NEXT NEWEST AFTER DELETE (My Assets) */
    function rmsPromoteNextUnlockedAssetCard() {
      if (!wrapperEl) return;

      // Find all remaining locked cards and promote the newest (highest entryId)
      const lockedCards = Array.from(wrapperEl.querySelectorAll('.shoshin-asset-card'))
        .filter(function (c) {
          if (!c || !c.dataset) return false;
          return String(c.dataset.locked || '') === '1';
        });
      ...
      lockedCards.forEach(function (c) {
        const id = parseInt(String((c.dataset && c.dataset.entryId) ? c.dataset.entryId : '0'), 10) || 0;
        if (id > bestId) { bestId = id; best = c; }
      });

      if (!best || bestId <= 0) return;

      // Unlock it
      try { best.dataset.locked = '0'; } catch (_) {}

      // Restore avatar (locked cards use RMS_LOCK_ICON_URL)
      try {
        const kind = String(best.dataset.kind || '').trim();
        const className = String(best.dataset.className || '').trim();
        const avatarImg = best.querySelector('.shoshin-asset-avatar img');

        if (avatarImg) {
          // Both Character + Support use Data.CLASS_IMAGES by className in your renderer
          const restored =
            (Data && Data.CLASS_IMAGES && Data.CLASS_IMAGES[className]) ? Data.CLASS_IMAGES[className]
              : (Data && Data.CLASS_IMAGES && Data.CLASS_IMAGES.default) ? Data.CLASS_IMAGES.default
                : (avatarImg.getAttribute('data-orig-src') || '');

          if (restored) avatarImg.src = String(restored);
        }
      } catch (_) {}
    }
    /* END RMS SOFT LOCK — AUTO-UNLOCK NEXT NEWEST AFTER DELETE (My Assets) */
      ...
      wrapperEl.addEventListener('click', function (e) {
        ...
        openDeleteModal(function () {
          ...
          return ajaxDeleteEntry(entryId, { kind: kind, formId: formId, refId: refId }).then(function () {
            // If we deleted an UNLOCKED asset, promote the newest locked one to unlocked
            var wasLocked = false;
            try { wasLocked = (card && card.dataset && String(card.dataset.locked || '') === '1'); } catch (_) {}

            if (card && card.parentNode) card.parentNode.removeChild(card);

            try {
              if (!wasLocked) rmsPromoteNextUnlockedAssetCard();
            } catch (_) {}
...
/* BEGIN RMS SOFT LOCK — BLOCK VIEW ASSIGNMENTS FOR LOCKED ASSET */
const isLocked = (card.dataset && String(card.dataset.locked || '') === '1');
if (isLocked) {
...
/* END RMS SOFT LOCK — BLOCK VIEW ASSIGNMENTS FOR LOCKED ASSET */
  ...
  String(imgKey).trim();
    ...
    function wireAssignButtons() {
      ...
      wrapperEl.addEventListener('click', function (e) {
        ...
        /* BEGIN RMS SOFT LOCK — BLOCK ASSIGN MODAL FOR LOCKED ASSET */
const isLocked = (card.dataset && String(card.dataset.locked || '') === '1');
if (isLocked) {
  const cardClassName = (card.dataset.className || '').trim();
  const kind = (card.dataset.kind || '').trim() || ((cardClassName === 'Artillery' || cardClassName === 'Sailing Ships') ? 'support' : 'character');
...
/* END RMS SOFT LOCK — BLOCK ASSIGN MODAL FOR LOCKED ASSET */
...
// Prefer explicit dataset.kind (set by the renderer) to avoid misclassification
const cardKind = (card.dataset.kind || '').trim();
const cardClass = (card.dataset.className || '').trim();
const kind = (cardKind === 'support')
  ? 'support'
  : ((cardClass === 'Artillery' || cardClass === 'Sailing Ships') ? 'support' : 'character');
...
if (supportType === 'Taiho') return 'Kayakujutsu';

// Vessel (Wasen + subtypes; keep legacy name as fallback until you delete old entries)
if (
  supportType === 'Wasen' ||
...
return '';
    ...
    function renderCharacterAssetCard(asset) {
      ...
      /* BEGIN RMS SOFT LOCK — PADLOCK IMAGE OVERRIDE (Character) */
      const imgSrc = (asset && asset.locked)
        ? RMS_LOCK_ICON_URL
        : (Data.CLASS_IMAGES[className] || Data.CLASS_IMAGES.default);
      /* END RMS SOFT LOCK — PADLOCK IMAGE OVERRIDE (Character) */
...
/* BEGIN RMS SOFT LOCK — Card data-locked flag (character) */
card.dataset.locked = (asset && asset.locked) ? '1' : '0';
/* END RMS SOFT LOCK — Card data-locked flag (character) */
            ...
            <tbody>
              <tr>
                ...
                <td class="shoshin-stat-cost-cell">
                  <div class="shoshin-stat-cell">
                    <div class="shoshin-stat-label">COST</div>
                    <div class="shoshin-stat-value cost-value">${asset.totalCost ? Core.esc(asset.totalCost) : '—'}</div>
                  </div>
                </td>
    ...
    function renderSupportAssetCard(asset) {
      ...
      const meta = Data.CLASS_META[className] || {};
      const supportType = asset.supportType || asset.name || '';


      let size = asset.size || meta.size || 'Medium';
      let descHtml = meta.description || '';
      /* BEGIN RMS SOFT LOCK — PADLOCK IMAGE OVERRIDE (Support) */
      let imgSrc = (asset && asset.locked)
        ? RMS_LOCK_ICON_URL
        : (Data.CLASS_IMAGES[className] || Data.CLASS_IMAGES.default);
      /* END RMS SOFT LOCK — PADLOCK IMAGE OVERRIDE (Support) */
      let displayName = meta.displayName || className;

if (supportType) {
  displayName = supportType;
  if (supportType === 'Taiho') {
    descHtml = '<em>Seige Cannon</em>';
  ...
  // Derive subtype from hull size category stored on the asset entry (Option 1)
  const hullCatRaw =
    Core.firstNonEmptyString(asset.asset_size, asset.assetSize, asset.hullSize, asset.sizeCategory, asset.size) || '';

  const hullCat = String(hullCatRaw).trim().match(/^(Medium|Large|Huge|Gargantuan|Colossal)\b/i);
  const hull = hullCat ? hullCat[1].charAt(0).toUpperCase() + hullCat[1].slice(1).toLowerCase() : '';
...
// Subtype-only display (per your requirement)
if (!subtype && (supportType === 'Kobaya' || supportType === 'Sekibune' || supportType === 'Atakebune')) {
  subtype = supportType; // already stored as subtype
}
if (subtype) displayName = subtype;
  ...
  imgSrc = Data.CLASS_IMAGES['Sailing Ships'] || imgSrc;
      ...
      /* BEGIN RMS SOFT LOCK — FINAL PADLOCK OVERRIDE (Support) */
      if (asset && asset.locked) {
        imgSrc = RMS_LOCK_ICON_URL;
      }
      /* END RMS SOFT LOCK — FINAL PADLOCK OVERRIDE (Support) */
      ...
      if (supportType === 'Taiho' && (!size || size === '--')) size = 'Large';
      ...
      const card = createBaseCard(detailsId);
card.dataset.className = className;
card.dataset.kind = 'support';
if (asset && asset.entryId) card.dataset.entryId = String(asset.entryId);

/* BEGIN RMS SOFT LOCK — Card data-locked flag (support) */
card.dataset.locked = (asset && asset.locked) ? '1' : '0';
/* END RMS SOFT LOCK — Card data-locked flag (support) */
...
assets.forEach((asset) => {
  ...
  // -------------------------------------------------------------------
  // Support Asset inference (client-side guard)
  // - Some newer Support Asset entries may not come through with kind="support"
  // - We infer support-kind + bucket (Artillery / Sailing Ships) from supportType
  // -------------------------------------------------------------------
  const supportType = Core.firstNonEmptyString(
    asset.supportType,
    asset.assetType,
    asset.name,
    asset.SupportAssetType
  ).trim();

  const isKnownSupportType =
    supportType === 'Taiho' ||
    supportType === 'Wasen' ||
    supportType === 'Kobaya' ||
    supportType === 'Sekibune' ||
  ...
  if (isKnownSupportType) {
    asset.kind = 'support';
    // Ensure bucket is stable for downstream logic (filters + assign modal)
    if (!asset.className || (asset.className !== 'Artillery' && asset.className !== 'Sailing Ships')) {
      asset.className = (supportType === 'Taiho') ? 'Artillery' : 'Sailing Ships';
    }
  }
...
const SUPPORT_ASSET_IMAGES = {
  ...
  Taiho: '/wp-content/uploads/2025/12/cannon.jpeg',

  // Vessel (Wasen + subtypes). Keep legacy Mokuzo as alias.
  Wasen: '/wp-content/uploads/2026/02/kobaya_colorized.jpg',
  Kobaya: '/wp-content/uploads/2026/02/kobaya_colorized.jpg',
  Sekibune: '/wp-content/uploads/2026/02/kobaya_colorized.jpg',
  Atakebune: '/wp-content/uploads/2026/02/kobaya_colorized.jpg',
...
const SUPPORT_ASSET_META = {
  Taiho: {
    shortDescription: 'Seige Cannon',
    sizeFallback: 'Large',
    dimensionFallback: '1" × 2"',
    rules: 'Seige cannon mounted on a wooden frame.'
  },
Wasen: {
...
'Mokuzo Hansen': {
  ...
  rules: 'Wooden sailing ship suitable for coastal engagements.'
    ...
    function computeHullStats(width, length) {
      ...
      const movementByCategory = { Medium: 6, Large: 6, Huge: 7, Gargantuan: 7, Colossal: 8 };
    ...
    function installMunitionsObserverIfNeeded() {
      ...
      const obs = new MutationObserver(() => {
        if (getSupportAssetName() !== 'Taiho') return;
  ...
  assetName === 'Mokuzo Hansen'
    ...
    function computeTotalCost() {
      ...
      if (assetName === 'Taiho') {
        baseCost = SUPPORT_ASSET_STATS.Taiho.cost || 0;
        const selected = getSelectedMunitions();
  ...
  assetName === 'Mokuzo Hansen'
    ...
    function computeTrainingReqList() {
      const assetName = getSupportAssetName();
      if (!assetName) return ['None'];
      if (assetName === 'Taiho') return ['Kayakujutsu'];
...
if (sizeContainer) sizeContainer.style.display = isVessel ? '' : 'none';
if (dimContainer) dimContainer.style.display = isVessel ? '' : 'none';


if (munSection) munSection.style.display = isTaiho ? '' : 'none';
if (munTable) munTable.style.display = isTaiho ? '' : 'none';
if (munWrap) munWrap.style.display = isTaiho ? '' : 'none';
...
if (isTaiho) {
  ...
  forceMunitionsRowsVisible();
    ...
    function updateHiddenFields() {
      ...
      if (assetName === 'Taiho') setHidden(FIELD_ID_ASSET_RYU, 'Kayakujutsu');
...
} else if (assetName === 'Taiho') {
  sizeText = 'Large';
  dimText = SUPPORT_ASSET_META.Taiho && SUPPORT_ASSET_META.Taiho.dimensionFallback ? SUPPORT_ASSET_META.Taiho.dimensionFallback : '1" × 2"';
} else {
