...
/**
 * GTM / Meta / GA4
 * Push successful account registration event
 */
add_action('wp_footer', function () {
    ...
    // Allowed post-registration destinations
    $is_registration_success_page =
        strpos($request_uri, '/my-account/') !== false
        || strpos($request_uri, '/membership-checkout/membership-confirmation/') !== false;

    if (!$is_registration_success_page) {
        return;
    }
