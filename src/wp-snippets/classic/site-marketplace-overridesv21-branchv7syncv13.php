...
add_filter( 'pmprowoo_get_membership_price', function ( $discount_price, $level_id, $original_price, $product ) {
	...
	if ( $check_product->get_meta( '_shoshin_exclude_member_discount' ) === 'yes' ) {
